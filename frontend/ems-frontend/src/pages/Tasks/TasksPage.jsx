...
export default function TasksPage({ isDarkMode, groupId }) {
  const [tasks, setTasks] = useState([
    { id: 1, title: '倒垃圾', assignee: '王小明', due: '今天 20:00', status: 'Pending' },
    { id: 2, title: '採買日常用品', assignee: '李小華', due: '明天', status: 'InProgress' },
    { id: 3, title: '繳網路費', assignee: '陳阿滴', due: '下週一', status: 'Done' }
  ]);
  ...
  const columns = [
    ...
    { title: '進行中', status: 'InProgress', color: 'bg-blue-500' },
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className={cn("text-2xl font-black", { "text-white": isDarkMode, "text-slate-900": !isDarkMode })}>家務分配任務板</h2>
          <p className="text-sm text-slate-500 font-medium">按住並拖曳任務來更改進度</p>
        </div>
